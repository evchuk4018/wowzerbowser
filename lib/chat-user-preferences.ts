...
export function parseChatUserPreferences(value: unknown): ChatUserPreferences | null {
  ...
  const candidate = value as { userPresence?: unknown; visionModel?: unknown; automationModel?: unknown };
  ...
  return { userPresence: candidate.userPresence.trim(), ...(Object.prototype.hasOwnProperty.call(candidate, "visionModel") ? { visionModel } : {}), automationModel };
}
