...
test("Auth.js is the only browser authentication path and Supabase stays storage-only", async () => {
  ...
  assert.match(storage, /@supabase\/supabase-js/);
  assert.doesNotMatch(storage, /supabase\.auth|signIn|signUp|magic/i);
