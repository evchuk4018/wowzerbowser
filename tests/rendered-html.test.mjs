...
test("keeps composer model and thinking controls accessible and responsive", async () => {
  ...
  assert.match(styles, /grid-template-columns: minmax\(320px, \.92fr\) minmax\(320px, 1\.08fr\)/);
  assert.match(styles, /grid-template-columns: repeat\(2, minmax\(0, 1fr\)\)/);
  assert.match(settings, /className="settings-nav-icon"/);
  assert.match(settings, /className="settings-nav-description"/);
  assert.match(settings, /className="settings-nav-chevron"/);
  ...
  assert.match(settings, /max-width: 820px/);
