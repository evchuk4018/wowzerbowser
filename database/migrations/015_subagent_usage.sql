...
alter table public.chat_usage_records
  ...
  check (request_kind in ('chat','title','reasoning_summary','image_analysis','image_text_analysis','image_visual_analysis','image_followup','chat_summary','chat_recall','dreaming','todo_planner','deep_research','subagent','automation','context_router'));
