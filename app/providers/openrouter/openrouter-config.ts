...
// OpenRouter accepts at most three model IDs in a fallback array. These
// candidates accept image input and advertise structured JSON output support,
// which is required by the combined image-analysis request.
