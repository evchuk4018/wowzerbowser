...
export const DOCUMENT_INGESTION_STAGES = {
  SIGNED_UPLOAD_URL: "signed-upload-url",
  BROWSER_UPLOAD: "browser-upload",
  SUPABASE_UPLOAD: "supabase-upload",
  FINALIZE_REQUEST: "finalize-request",
  SUPABASE_DOWNLOAD: "supabase-download",
...
export const DOCUMENT_INGESTION_STAGE_ORDER: readonly DocumentIngestionStage[] = Object.freeze([
  DOCUMENT_INGESTION_STAGES.SIGNED_UPLOAD_URL,
  DOCUMENT_INGESTION_STAGES.BROWSER_UPLOAD,
  DOCUMENT_INGESTION_STAGES.SUPABASE_UPLOAD,
  DOCUMENT_INGESTION_STAGES.FINALIZE_REQUEST,
  DOCUMENT_INGESTION_STAGES.SUPABASE_DOWNLOAD,
