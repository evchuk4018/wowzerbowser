...
export function createDocumentReadHandler(dependencies = {
  ...
  return async function GET(
    ...
    try {
      const opened = await dependencies.openAuthorizedDocument(owner.id, conversationId, documentId);
...
export const GET = createDocumentReadHandler();
