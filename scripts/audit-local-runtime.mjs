...
const forbiddenClientPatterns = [
  ...
  ["server-secret-name", /(?:AUTH_SECRET|DATABASE_URL|POSTGRES_PASSWORD|APP_OWNER_PASSWORD|DEEPSEEK_API_KEY|OPENROUTER_API_KEY|PIPEDREAM_CONNECT_API_KEY|DISCORD_BOT_TOKEN|GOOGLE_OAUTH_CLIENT_SECRET|CONNECTOR_CREDENTIAL_ENCRYPTION_KEY|LOCAL_DRIVE_API_TOKEN)/u],
];
